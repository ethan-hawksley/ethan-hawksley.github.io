...
I also encountered some <abbr title="Content Layout Shift">CLS</abbr> issues surrounding my choice of font. I personally love the look of the [Inter font](https://rsms.me/inter/) and included it in my project. However, although 300 KiB may not sound like a lot, on a slow connection it’s a noticeable delay. After some research I discovered the [fontTools library](https://github.com/fonttools/fonttools) and managed to shrink down the Inter font to 70 KiB by scrubbing out the characters from Unicode selections I'm unlikely to use like Greek. To eliminate the final remnants of CLS, I changed my `@font-face` declaration to `optional` instead of `swap`. The first time a user visits the site, if the font doesn't load within 100 ms, their system fonts will load instead. Not a perfect fix, but the browser does cache Inter for future pages, so in reality not that impactful.

## The Conclusion

Astro has been a pleasure to work with, and I can easily see myself using it in future projects now I've adjusted to it.

![Perfect Google PageSpeed Score](/images/blog/building-an-astro-blog/pagespeed-insights.webp)

[A perfect score](https://pagespeed.web.dev/analysis/https-hawksley-dev/x51rtffn8u?form_factor=mobile) has got to be one of the most satisfying feelings after doing a site redesign.
